...
**Desenvolvedor Full-Stack | Especialista em Delphi + Firebird → Python Moderno**  
Migrando sistemas legados para soluções robustas, escaláveis e com cara de 2025+  

🔭 Atualmente focado em automação, migrações de banco de dados e APIs Python  
💻 Mais de 10 anos de experiência com Delphi, Firebird e SQL avançado  
⚙️ Apaixonado por performance, procedures armazenadas e arquitetura limpa  
🌱 Aprendendo diariamente FastAPI, Docker e boas práticas de backend moderno  
...
💬 Me chama no LinkedIn ou manda um e-mail, sempre respondo rápido!

> “Código legado não é problema, é oportunidade de fazer melhor.” – Pedlu Santiago
